            ...
            if (this.series !== null && this.series !== undefined) {
                ...
                this.series.forEach(function (series) {
                    ...
                    for (i=0; i<returnData.length; i++) {
                        ...
                        // x = + & y = + => class 1
                        if (returnData[i].cx > 0 && returnData[i].cy > 0) {
                            console.log(returnData[i].key + ' Class 1');

                        }
                        // returnData[i].cx = - & returnData[i].cy = + => class 2
                        if (returnData[i].cx < 0 && returnData[i].cy > 0) {
                            console.log(returnData[i].key + ' Class 2');
                        }
                        // returnData[i].cx = - & returnData[i].cy = - => class 3
                        if (returnData[i].cx < 0 && returnData[i].cy < 0) {
                            console.log(returnData[i].key + ' Class 3');
                        }
                        // returnData[i].cx = + & returnData[i].cy = - => class 4
                        if (returnData[i].cx > 0 && returnData[i].cy < 0) {
                            console.log(returnData[i].key + ' Class 4');
                        }
                    }
